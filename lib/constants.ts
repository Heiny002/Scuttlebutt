...
// Claude pricing (Sonnet 4.5) per million tokens
export const INPUT_COST_PER_MILLION = 300; // $3.00 in cents
export const OUTPUT_COST_PER_MILLION = 1500; // $15.00 in cents
